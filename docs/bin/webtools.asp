...
cachepath="C:/projects/chillik/machine/cache/webtools/"
output = utilitygate.readCache(cachepath)
if output == None:
	sqlgate.cn = sqlgate.open("dsn=webtools;uid=root;pwd=securemarc")
	sqlgate.cn2 = ""
	requests = TimeTree2.webtools.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="aey", appname="chillik", cachepath=cachepath, project="chillik")
