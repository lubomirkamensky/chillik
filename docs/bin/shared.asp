...
cachepath="C:/projects/chillik/machine/cache/shared/"
output = utilitygate.readCache(cachepath)
if output == None:
	sqlgate.cn = sqlgate.open("dsn=shared;uid=root;pwd=securemarc")
	sqlgate.cn2 = ""
	requests = TimeTree2.shared.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="aey", appname="chillik", cachepath=cachepath, project="chillik")
