...
requests = None
cachepath="C:/projects/chillik/machine/cache/crm/"
...
if output == None:
	...
	requests = TimeTree2.crm.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="aey", appname="chillik", cachepath=cachepath, project="chillik")
