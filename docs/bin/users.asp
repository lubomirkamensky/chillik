...
if output == None:
	...
	sqlgate.cn2 = ""
	requests = TimeTree2.users.Requests(utilitygate=utilitygate, xmlgate=xmlgate, sqlgate=sqlgate, formgate=formgate, session=Session.SessionID, user="", appname="users", cachepath=cachepath, project="chillik")
